...
Uint bl_matchfileSplit (void *space, Uint fidx, Uint cidx, Uint pos, 
    matchfileCross_t *cs,
...
Uint bl_matchfileSplit (void *space, Uint fidx, Uint idx, Uint pos, matchfileCross_t *cs, char ref, matchfileSampleStats_t *stats, unsigned char show, void *nfo);
...
void printsplicebed (void *space, splicemap_t *sm, char *title, FILE *out, FILE *transout);
