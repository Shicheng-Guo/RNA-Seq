...
#define MATE_TAG 54
 ...
 const char SORTBIN5[] = "-t $'\\t' -k2,2n";
 const char SORT5[] = "-t $'\\t' -k5,5 -k2,2n";
...
/*unpaired query or mate*/
 ...
 const char SORTBIN12[] = "-t $'\\t' -k11,11n";
 const char SORT12[] = "-t $'\\t' -k13,13 -k11,11n";

/*mate and query*/
 const char HEAD13[] = "#pair status;descr;semi global alignment distance;seed score;seed Evalue;seed qstart;seed qend;semi global alignment matches;semi global alignment mismatches;semi global alignment insertions;semi global alginment deletions;strand;start of semi global alignment in subject(reference) sequence;end of semi global alignment in subject sequence;sequence descr;meop string;number of matches;number of mate matches";
 ...
 const char HEAD14[] = "#descr;semi global alignment distance;seed score;seed Evalue;seed qstart;seed qend;semi global alignment matches;semi global alignment mismatches;semi global alignment insertions;semi global alginment deletions;strand;start of semi global alignment in subject(reference) sequence;end of semi global alignment in subject sequence;sequence descr;meop string;query";
...
/*SAM*/
 ...
 const char SORTBIN15[] = "-t $'\\t' -k4,4n";
 const char SORT15[] = "-t $'\\t' -k3,3 -k4,4n";

 const char HEAD16[] = "SAM";
 const int FORMAT16[] = {SAM_QRY, SAM_MATE_FLAG, MATE_SEQ_DESC, MATE_SEQ_S, SAM_MATE_MAPQ, SAM_MATE_CIGAR, SAM_QRY_REF, SEQ_S, SAM_MATE_ISIZE, MATE_QRY_SEQ, MATE_QUAL, MATE_TAG, -1};
